...
class MppDecoder(tf.keras.layers.Layer):
    ...
    def __init__(self,iFfnUnits, iNrOfTimeSteps ,**kwargs):
        ...
        self.dense = tf.keras.layers.Dense(units=iFfnUnits*iNrOfTimeSteps, use_bias =False)
...
class ProjectionHead(tf.keras.layers.Layer):
    ...
    def __init__(self,iFfnUnits ,**kwargs):
        ...
        self.dense = tf.keras.layers.Dense(units=iFfnUnits, activation='tanh',use_bias = False)
